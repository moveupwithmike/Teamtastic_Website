        ...
        <section className="w-full py-8 bg-[#D81B60] text-center shadow-md">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left space-y-1.5">
              <h3 className="text-lg md:text-xl font-bold text-white tracking-wide flex flex-wrap items-center justify-center md:justify-start gap-2">
            ...
            <Link
              href="/#quiz"
              className="px-6 py-2.5 rounded-xl bg-white text-pink-600 font-bold text-xs hover:bg-zinc-100 transition-all shadow-md shrink-0 flex items-center justify-center gap-1.5 self-center"
            >
              BOOK YOUR EVENT
