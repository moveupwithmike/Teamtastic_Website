...
export default function sitemap() {
  const staticRoutes = [
    ...
    url("/virtual-anniversary-party",        0.85, "weekly"),
    url("/virtual-graduation-party",         0.85, "weekly"),
    url("/multigenerational-family-games",   0.85, "weekly"),
    url("/how-to-plan-a-virtual-family-reunion", 0.85, "monthly"),
