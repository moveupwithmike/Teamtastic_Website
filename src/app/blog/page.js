...
const posts = [
  ...
  {
    slug: "virtual-trivia-for-work",
    title: "Virtual Trivia for Work: How to Run a Game People Enjoy",
    excerpt: "Better categories, pacing, team rules, and custom questions for running online trivia that remote employees actually want to play.",
    readTime: "7 min read",
    date: "July 9, 2026",
    category: "Trivia",
  ...
  {
    slug: "corporate-game-show-ideas-for-work",
    title: "Corporate Game Show Ideas for Work: 12 Formats Teams Love",
    excerpt: "Game show formats for virtual and hybrid company events, including survey rounds, music games, meme battles, and year-in-review shows.",
    readTime: "8 min read",
    date: "July 9, 2026",
    category: "Game Shows",
  ...
  {
    slug: "team-building-for-remote-engineering-teams",
    title: "Team Building for Remote Engineering Teams: Low-Cringe Ideas",
    excerpt: "Practical, structured team building ideas for developers, QA, product teams, and technical leaders who do not want forced fun.",
    readTime: "8 min read",
    date: "July 9, 2026",
  ...
  {
    slug: "zoom-team-building-games",
    title: "Zoom Team Building Games for Work: 17 Ideas That Actually Land",
    excerpt: "Planning another remote event? These Zoom-friendly team games use clear rules, fast rounds, and low-pressure participation so the room actually wakes up.",
    readTime: "8 min read",
    date: "July 9, 2026",
  ...
  {
    slug: "virtual-holiday-party-games",
    title: "Virtual Holiday Party Games for Work: 15 Easy Ideas",
    excerpt: "A remote holiday party can feel like a real celebration. Use these inclusive online games for Zoom, Teams, and year-end company events.",
    readTime: "7 min read",
    date: "July 9, 2026",
  ...
  {
    slug: "employee-engagement-activities-remote-teams",
    title: "Employee Engagement Activities for Remote Teams: 19 Practical Ideas",
    excerpt: "Remote engagement improves with consistent rituals, structured games, and low-friction connection. Here are practical ideas HR teams can actually run.",
    readTime: "9 min read",
    date: "July 9, 2026",
    category: "HR & Culture",
    categoryColor: "text-emerald-400 border-emerald-500/30 bg-emerald-500/10",
