...
export default async function ProspectList({ searchParams }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="grid gap-3 rounded-2xl border border-white/10 bg-slate-900/65 p-4 sm:grid-cols-[minmax(240px,1fr)_220px_220px_auto]">
