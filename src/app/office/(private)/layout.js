    ...
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6">
      <header className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-white/10 bg-slate-900/70 p-5">
        ...
        <nav className="flex flex-wrap items-center gap-3 text-sm">
          ...
          <Link className="rounded-lg bg-white/5 px-4 py-2 hover:bg-white/10" href="/office/voice">Voice</Link>
          ...
          <Link className="rounded-lg bg-white/5 px-4 py-2 hover:bg-white/10" href="/office/morning-brief">Eddie</Link>
