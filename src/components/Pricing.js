...
const tiers = [
  {
    ...
    price: "$35–$45",
    unit: "per person",
    blurb: "60 minutes • up to 100 participants",
    features: [
      "Vetted Professional MC host (100% live)",
      "High-energy Trivia + Mini-Game rounds",
      "Live scoreboards, music & virtual confetti",
      "Full browser-based play (Zoom/Teams friendly)",
      "Vibrant standard games catalog access",
      "Inclusive room-pacing and energy curation"
    ],
    cta: "Book Core Experience",
    href: "/#quiz",
    highlight: false,
  ...
  },
  {
    ...
    price: "$50–$65",
    unit: "per person",
    blurb: "75–90 minutes • deeper engagement",
    features: [
      "Vetted Professional MC host + extended time",
      "Everything in Core + advanced game catalog",
      "Custom branded leaderboard themes & logos",
      "Custom tailored questions & company inside jokes",
      "Dedicated virtual Awards Ceremony & spotlights",
      "Pre-event event coordination & planning consultation"
    ],
    cta: "Book Premium Celebration",
    href: "/#quiz",
    highlight: true,
  ...
  {
    name: "Enterprise Connection Plan",
    price: "from $4,000",
    unit: "annual",
    blurb: "6–8 events/year • priority scheduling",
    features: [
      "Quarterly company culture boosts",
      "Priority Senior Host booking & calendar locks",
      "Custom brand aesthetics & analytics reports",
      "White-glove coordination & dedicated planner",
      "Structured B2B corporate billing (PO friendly)",
      "Tailored gamified onboarding & milestone events"
    ],
    cta: "Talk to Us",
